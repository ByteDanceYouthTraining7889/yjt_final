...
func (g Guanzhu) UserguanzhuList(db *gorm.DB) (*[30]User, error) {
	...
	var guanzhuuserlist [30]User
	for k, v := range guanzhulist {
...
func (g Guanzhu) UserFensiList(db *gorm.DB) (*[30]User, error) {
	var guanzhulist []Guanzhu
	var err error
